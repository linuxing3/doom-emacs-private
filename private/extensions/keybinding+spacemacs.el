...
(map! [remap evil-jump-to-tag] #'projectile-find-tag
      ...
      (:leader
       ...
       (:desc "workspace" :prefix "TAB"
        :desc "All"                 :n "TAB" #'+workspace/display
        :desc "New"                 :n "n"   #'+workspace/new
        :desc "Load"                 :n "l"   #'+workspace/load
        :desc "Session"                 :n "L"   (λ! (+workspace/load-session))
        :desc "Save"                 :n "s"   #'+workspace/save
        :desc "Save Session"                 :n "S"   #'+workspace/save-session
        :desc "Choose"                 :n "."   #'+workspace/switch-to
        :desc "Close All"                 :n "x"   #'doom/kill-all-buffers
        :desc "Kill Session"                 :n "X"   #'+workspace/kill-session
        :desc "Delete workspace"                 :n "d"   #'+workspace/delete
        :desc "Load Session"                 :n "L"   #'+workspace/load-session
        :desc "Next"                 :n "]"   #'+workspace/switch-right
        :desc "Prev"                 :n "["   #'+workspace/switch-left
        :desc "WS0"                 :n "1"   (λ! (+workspace/switch-to 0))
        :desc "WS1"                 :n "2"   (λ! (+workspace/switch-to 1))
        :desc "WS2"                 :n "3"   (λ! (+workspace/switch-to 2))
        :desc "WS3"                 :n "4"   (λ! (+workspace/switch-to 3))
        :desc "WS4"                 :n "5"   (λ! (+workspace/switch-to 4))
        :desc "WS5"                 :n "6"   (λ! (+workspace/switch-to 5))
        :desc "WS6"                 :n "7"   (λ! (+workspace/switch-to 6))
        :desc "WS7"                 :n "8"   (λ! (+workspace/switch-to 7))
        :desc "WS8"                 :n "9"   (λ! (+workspace/switch-to 8))
        :desc "WS9"                 :n "0"   #'+workspace/switch-to-last)
       ...
       ;; 代码 c
       (:desc "code" :prefix "c"
        :desc "Project Tab"               :n  "t" (cmd! (my-setup-develop-environment "workspace" (read-from-minibuffer "FileName:")))
        :desc "Errors"               :n  "x" #'flycheck-list-errors
        :desc "Expand Macro"               :n  "X" #'macrostep-expand
        :desc "Eval Buffer"               :n  "e" #'+eval/buffer
        :desc "Format Buffer"               :n  "f" #'+format/buffer
        :v  "e" #'+eval/region
        :desc "Replace Region"               :nv "E" #'+eval:replace-region
        :desc "Build"               :nv "b" #'+eval/build
        :desc "Definition"               :n  "d" #'evil-goto-definition
        :desc "Repl"               :n  "r" #'+eval/open-repl
        :v  "r" #'+eval:repl)
       ;;  文件 f
       (:desc "file" :prefix "f"
        :desc "Private Config"                :n "1" #'+default/browse-config
        :desc "Private note"                :n "2" #'+default/browse-notes
        :desc "Snippets"                :n "3" #'+default/browse-snippets
        :desc "Templates"                :n "4" #'+default/browse-templates
        :desc "Open"                :n "." #'find-file
        :desc "Sudo Open"                :n ">" #'doom/sudo-find-file
        :desc "Finder"                :n "/" #'projectile-find-file
        :desc "Quick Jump"                :n "?" #'counsel-file-jump
        :desc "Find Others"                :n "a" #'projectile-find-other-file
        :desc "Editconfig"                :n "c" #'editorconfig-find-current-editorconfig
        :desc "Dired"                :n "d" #'dired
        :desc "Find Emacs.d"                :n "e" #'+default/find-in-emacsd
        :desc "Explore Emacs.d"                :n "E" #'+default/browse-emacsd
        :desc "Recent"                :n "r" #'recentf-open-files
        :desc "Project Recent"                :n "R" #'projectile-recentf
        :desc "Buffer Name"                :n "y" #'+default/yank-buffer-filename
        )
