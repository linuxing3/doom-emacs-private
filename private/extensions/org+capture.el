...
With prefix argument, also display headlines without a TODO keyword."
  ...
  (add-to-list 'org-capture-templates
               '("xs"
                 ...
                 (file "~/.config/doom/private/templates/capture-template/snippet.template")
                 ;; "* %?\t%^g\n #+BEGIN_SRC %^{language}\n\n#+END_SRC"
                 :kill-buffer t))
  ...
  (add-to-list 'org-capture-templates
               '("xb"
                 ...
                 (file "~/.config/doom/private/templates/capture-template/billing.template")
                 ;; " | %U | %^{类别} | %^{描述} | %^{金额} |"
                 :kill-buffer t))
  ...
  (add-to-list 'org-capture-templates
               '("xc"
                 ...
                 (file "~/.config/doom/private/templates/capture-template/contact.template")
  ...
  (add-to-list 'org-capture-templates
               '("tp"
                 ...
                 (file "~/.config/doom/private/templates/capture-template/project.template")
                 :empty-line 1
                 :clock-resume t))
  ...
  (add-to-list 'org-capture-templates
               '("P"
                 ...
                 (file "~/.config/doom/private/templates/capture-template/phone.template")
  ...
  (add-to-list 'org-capture-templates
               '("h"
                 ...
                 entry
                 (file habit-org-file)
                 (file "~/.config/doom/private/templates/capture-template/habit.template")
                 ;; "* %^{Habit cards|music|balls|games}\n  %?"
                 :immediate-finish t
                 :new-line 1))
  ...
  (add-to-list 'org-capture-templates
               '("n"
                 ...
                 entry
                 (file notes-org-file)
                 (file "~/.config/doom/private/templates/capture-template/notes.template")
                 ;; "* %^{Loggings For...} %t %^g\n  %?"
                 :immediate-finish t
                 :new-line 1))
  ...
  (add-to-list 'org-capture-templates
               '("i"
                 ...
                 entry
                 (file inbox-org-file)
                 (file "~/.config/doom/private/templates/capture-template/inbox.template")
                 ;; "* [#%^{Priority}] %^{Title} %^g\n SCHEDULED:%U %?\n"
                 :immediate-finish t
                 :new-line 1))
  )
